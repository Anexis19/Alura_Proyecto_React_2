...
const Equipo = (props) =>{
    ...
    // A continuacion se le aplica una condicion para determinar si un equipo contiene colaboradores o no
    return <>

    {
        colaboladores.length > 0 &&
        <section className="contenedorEquipo" style={{backgroundColor: colorSecundario}}>
